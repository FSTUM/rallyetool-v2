...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, default="", max_length=200, verbose_name="RECAPTCHA_PRIVATE_KEY"),
        ),
        migrations.AddField(
            model_name="settings",
            name="recaptcha_public_key",
            field=models.CharField(blank=True, default="", max_length=200, verbose_name="RECAPTCHA_PUBLIC_KEY"),
        ),
        migrations.AddField(
            model_name="settings",
